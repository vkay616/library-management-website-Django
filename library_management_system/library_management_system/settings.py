...
SECRET_KEY = 'django-insecure-qrh94&lgx+b30rs=_k2ys0fc^fmrjlyo2#criyb(grth+!nr%*'
...
INSTALLED_APPS = [
    ...
    'crispy_forms',
    'crispy_bootstrap5',
    # adding library_app to installed apps
...
TEMPLATES = [
    {
        ...
        # adding templates folder to the directory
        'DIRS': [
            BASE_DIR / 'templates'
        ],
        'APP_DIRS': True,
...
# adding static folder to the directory
STATICFILES_DIRS = [
    BASE_DIR / 'static'
]
